package org.example.develop_todo.lv2.controller;

import java.util.HashMap;
import java.util.List;
import java.util.Map;
import lombok.RequiredArgsConstructor;
import org.example.develop_todo.lv2.dto.UserRequestDto;
import org.example.develop_todo.lv2.dto.UserResponseDto;
import org.example.develop_todo.lv2.service.UserService;
...
public class UserController {
  ...
  public ResponseEntity<Map<String, UserResponseDto>> createUser(@RequestBody UserRequestDto dto) {
    UserResponseDto userResponseDto =
        this.userService.createUser(dto.getUsername(), dto.getEmail());
  ...
  public ResponseEntity<Map<String, UserResponseDto>> updateUser(
    ...
    UserResponseDto userResponseDto =
        this.userService.updateUser(id, dto.getUsername(), dto.getEmail());
