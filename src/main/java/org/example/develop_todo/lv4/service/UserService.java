...
public class UserService {
   ...
   * @return 조회된 사용자 정보
   */
  public UserResponseDto findByPasswordAndEmail(String password, String email) {
    User findUser = this.userRepository.findByPasswordAndEmailElseOrThrow(password, email);
    return UserResponseDto.toDto(findUser);
  }
}
